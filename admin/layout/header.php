<?php 
global $judul;
require_once($_SERVER['DOCUMENT_ROOT'] . '/simt-luminor/config.php');
?>
      ...
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="<?= base_url('admin/home/home.php') ?>">
              <img src="<?= base_url() ?>/assets/img/logo2.png" alt="Tabler" class="navbar-brand-image" style="width: 150px; height: auto;">
            </a>
          </h1>
          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown ps-3">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url('<?= base_url('/assets/img/foto_user/') . $_SESSION['foto'] ?>')"></span>
          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/dashboard_statistik.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/data_trainee/trainee.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
                    </span>
                    <span class="nav-link-title">Trainee</span>
                  </a>
                </li>
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?= base_url('admin/data_divisi/divisi.php') ?>">Divisi</a>
                        <a class="dropdown-item" href="<?= base_url('admin/data_lokasi_presensi/lokasi_presensi.php') ?>">Lokasi dan Waktu Presensi</a>
                      </div>
                    </div>
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#navbar-rekap" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?= base_url('admin/presensi/rekap_harian.php') ?>">Rekap Harian</a>
                        <a class="dropdown-item" href="<?= base_url('admin/presensi/rekap_bulanan.php') ?>">Rekap Bulanan</a>
                      </div>
                    </div>
                  </div>
                </li>
