...
<h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
  <a href="<?= base_url('trainee/home/home.php') ?>">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <div class="d-none d-xl-block ps-2">
                  ...
                  <div class="mt-1 small text-secondary"><?= $_SESSION['nama_divisi']; ?></div>
                </div>
              </a>
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="<?= base_url('trainee/fitur_lainnya/profile.php') ?>" class="dropdown-item">Profile</a>
                <a href="<?= base_url('trainee/fitur_lainnya/ubah_password.php') ?>" class="dropdown-item">Ubah Password</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('trainee/home/home.php') ?>">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('trainee/presensi/rekap_presensi.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('trainee/ketidakhadiran/ketidakhadiran.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
