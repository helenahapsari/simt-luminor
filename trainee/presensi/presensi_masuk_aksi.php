...
// --- PERBAIKAN: Ambil jam_masuk DAN toleransi dari database ---
...
$toleransi   = $data_lokasi['toleransi']; // Ambil nilai toleransi dari database
...
/* 1) WAKTU DARI SERVER & LOGIKA TERLAMBAT (Dinamis) */
$tanggal_masuk = date('Y-m-d');
$jam_masuk_skrg = date('H:i:s'); 

// --- PERBAIKAN: Ganti '+45 minutes' jadi variabel $toleransi ---
