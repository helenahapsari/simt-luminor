...
if(isset($_POST['submit'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!empty($pesan_kesalahan)){
      ...
      $result = mysqli_query($connection, "INSERT INTO ketidakhadiran(id_trainee, keterangan, deskripsi, tanggal, status_pengajuan, file) VALUES('$id', '$keterangan', '$deskripsi', '$tanggal', '$status_pengajuan', '$nama_file')");
    ...
    <div class="card col-md-6">
      <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
          <input type="hidden" value="<?= $_SESSION['id'] ?>" name="id_trainee">
          <div class="mb-3">
